...
# EPIC EDIT start -- nick.shin 2019-10-22 -- UEMOB-482
# no longer needed as of 1.39.18 -- leaving here for reference
#
#      options.js_libraries.append(shared.path_from_root('src', 'library_exceptions.js'))
# EPIC EDIT end -- nick.shin 2019-10-22 -- UEMOB-482
