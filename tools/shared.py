...
#  print('emscripten requires at least python 3.5 (or python 2.7.12 or above)', file=sys.stderr)
  print('ERROR: emscripten requires at least python 3.5 (or python 2.7.12 or above)', file=sys.stderr)
  print('NOTE: python used is locaed at: ', sys.executable)
# EPIC EDIT end -- nick.shin 2019-05-29 -- UE-75005
  sys.exit(1)
...
# as of 1.39.0 -- the following is no longer needed -- python3 seems to be alot more stable -- leaving for reference
#
